...
bool operator==(const ::laser_assembler::AssembleScans2Response_<ContainerAllocator1> & lhs, const ::laser_assembler::AssembleScans2Response_<ContainerAllocator2> & rhs)
{
