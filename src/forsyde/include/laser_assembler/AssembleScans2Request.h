...
bool operator==(const ::laser_assembler::AssembleScans2Request_<ContainerAllocator1> & lhs, const ::laser_assembler::AssembleScans2Request_<ContainerAllocator2> & rhs)
{
